 ...
 * start value: 0xFFFF
 * 
 * This CRC checksum is identified as "CRC-16/MCRF4XX"
 * http://reveng.sourceforge.net/crc-catalogue/all.html
 * 
 * Implementation below is the fast lookup table method by Github uster wensonsmith
...
function addCrcToBuffer (buffer) {
    const finalLength = buffer.length + 3
...
module.exports.addCrcToBuffer =  addCrcToBuffer